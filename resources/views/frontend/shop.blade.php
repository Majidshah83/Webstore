    ...
    <div class="page-holder">
      ...
      <header class="header bg-white">
        <div class="container px-0 px-lg-3">
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.html"><span class="font-weight-bold text-uppercase text-dark">The Book Store</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link active" href="#">Shop</a>
                </li>
          ...
          <div class="modal-content">
            <div class="modal-body p-0">
              <div class="row align-items-stretch">
                <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center" style="background: url(public/frontend/img/product-5.jpg)" href="public/frontend/img/product-5.jpg" data-lightbox="productview" title="Red digital smartwatch"></a><a class="d-none" href="{{asset('public/frontend/img/product-5-alt-1.jpg')}}" title="Red digital smartwatch" data-lightbox="productview"></a><a class="d-none" href="{{asset('public/frontend/img/product-5-alt-2.jpg')}}" title="Red digital smartwatch" data-lightbox="productview"></a></div>
                <div class="col-lg-6">
      ...
      <div class="container">
        ...
        <section class="py-5">
         ...
         @if (\Session::has('success'))
            <div class="alert alert-success" style="background-color: yellow; margin-right: 36%;">
                  ...
                  <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="{{asset('public/uploads/products_image/' .$product->product_image)}}" alt="..."></a>
                      ...
                      <h6 id="productname"> <a class="reset-anchor" href="detail.html">{{$product->product_name}}</a></h6>
